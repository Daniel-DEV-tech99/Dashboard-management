...
import BottomNavItems from 'src/layouts/components/vertical/BottomNavItems'
...
import NotificationIcon from 'src/iconify-bundle/svg/notificationIcon'
import SettingsIcon from 'src/iconify-bundle/svg/figma/settings'
import SupportIcon from 'src/iconify-bundle/svg/figma/supportIcon'
          ...
          <ScrollWrapper
            {...(hidden
              ? {
                  ...
                  sx: { height: 'calc(100% - 120px)', overflowY: 'auto', overflowX: 'hidden', paddingBottom: '70px' }
                }
              : {
